...
function button_utils.buttonHeldHandler(_, device, command) 

   log.debug("step, down_hold")
   device:emit_event(capabilities.button.button.down_hold())
end

function button_utils.buttonOnHandler(_, device, command) 
   log.debug("on, up")
   device:emit_event(capabilities.button.button.up())
end

function button_utils.buttonOffHandler(_, device, command) 
   log.debug("off, down")
   device:emit_event(capabilities.button.button.down())
end

function button_utils.buttonStopHandler(_, device, command) 
   log.debug("stop, up_hold")
   device:emit_event(capabilities.button.button.up_hold())
end
